 ...
 * Update  : 2026-02-08
 * Remarks : 
 * - V1.5.0 AnnouncementListItem (is_read, read_count) を追加
 * V1.4.1
 * - 結合クエリ用の AnnouncementReadDetail を追加
 * V1.4.0
 * - announcements.id -> announcement_id (BIGINT)
 * - announcement_reads.id -> read_id (UUID)
 * - announcement_reads.line_id -> member_id (UUID: members.id と紐付け)
 */
