/**
 * Filename: src/V1/utils/memberHelpers.test.ts
 * Version : V1.0.0
 * Update  : 2026-02-25
 * 内容：
 * V1.0.0
 * - 新規作成。V1の会員関連ユーティリティ関数の単体テストコードを作成。
 */
...
import {
  ...
  hasOfficerRole
} from '@v1/utils/memberHelpers'
import { MemberInput, ROLES } from '@v1/types/member'

describe('memberHelpers 総合検証 V1.0.0', () => {
